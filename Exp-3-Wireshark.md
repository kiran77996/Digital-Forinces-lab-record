...
![(images/exp3-step1.png)](https://github.com/kiran77996/Digital-Forinces-lab-record/blob/main/ex3.1.jpg?raw=true)
...
![(images/exp3-step2.png)](https://github.com/kiran77996/Digital-Forinces-lab-record/blob/main/ex3.2.jpg?raw=true)

**Step-3:** After starting packet capture, go to a website and log in with credentials.  

![(images/exp3-step3.png)](https://github.com/kiran77996/Digital-Forinces-lab-record/blob/main/ex3.3.jpg?raw=true)

**Step-4:** Return to Wireshark and apply filters like **HTTP** to find HTTP packets on the network.  

![(images/exp3-step4.png)](https://github.com/kiran77996/Digital-Forinces-lab-record/blob/main/ex3.4.jpg?raw=true)
...
![(images/exp3-step6.png)](https://github.com/kiran77996/Digital-Forinces-lab-record/blob/main/ex3.5.jpg?raw=true)

**Step-7:** If credentials are not found with GET, apply the **POST method filter**:  
- http.request.method == "POST"

![(images/exp3-step7.png)](https://github.com/kiran77996/Digital-Forinces-lab-record/blob/main/ex3.6.jpg?raw=true)

As you analyze the HTML form in POST requests, you can view user credentials (e.g., username and password).  
Example:  
- Form item: "uname" = "KIRAN"
- Form item: "pass" = "1234"
